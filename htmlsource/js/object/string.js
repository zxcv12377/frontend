...
console.log(`특정 위치의 문자 반환 : ${msg1.charAt(4)}`);
console.log(`특정 위치의 문자 반환 : ${msg1.at(4)}`);
console.log(`특정 문자의 위치 반환 : ${msg1.indexOf("j")}`);
console.log(`특정 문자의 포함 여부 : ${msg1.includes("j")}`);
...
console.log(`문자열 찾기 (serach - 시작위치): ${msg1.search("ja")}`);
console.log(`문자열 대문자 변경: ${msg1.toUpperCase()}`);
console.log(`문자열 소문자 변경: ${msg2.toLowerCase()}`);
